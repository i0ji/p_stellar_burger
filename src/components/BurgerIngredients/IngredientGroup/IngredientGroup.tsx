...
export default function IngredientGroup({type, ingredients}: IIngredientGroupProps) {
    ...
    const IngredientCard = ({
        ...
        const ingredientCount = addedIngredients.reduce(
            (count: number, ingredient: IIngredient) => {
        ...
        const isCurrentBun =
            bunIngredients &&
            bunIngredients.name === name &&
            bunIngredients.price === price;
        ...
        return (
            ...
            >
                ...
                {isCurrentBun && <span className="text text_type_digits-default">2</span>}
            </div>
        );
    };
